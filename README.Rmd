...
for (i in 1:10){
  ...
  cp_rest <- FreSpeD:::tv_estimations_cp(signal_rest, windowLen = 512, nCores =1, plot =FALSE)
  cp_task <- FreSpeD:::tv_estimations_cp(signal_task, windowLen = 512, nCores= 1, plot = FALSE)
