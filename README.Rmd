...
for (i in 1:2){
  ...
  cp_rest <- FreSpeD:::tv_estimations_cp(signal_task, windowLen = 512, nCores =1, plot =FALSE)
  cp_task <- FreSpeD:::tv_estimations_cp(signal_task, windowLen = 512, nCores= 1, plot = FALSE)
  
  list_cp_rest[[i]] <- FreSpeD:::FreSpeD_summary(cp_rest, windowLen = 500, plot = FALSE)
  list_cp_task[[i]] <- FreSpeD:::FreSpeD_summary(cp_task, windowLen = 500, plot = FALSE)
}
