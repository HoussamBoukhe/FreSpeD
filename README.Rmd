...
for (i in 1:10){
  print(paste("Analysing patient", i))
  ...
  cp_rest <- FreSpeD:::tv_estimations_cp(signal_rest, windowLen = 512, nCores =12, plot =FALSE)
  cp_task <- FreSpeD:::tv_estimations_cp(signal_task, windowLen = 512, nCores= 12, plot = FALSE)
